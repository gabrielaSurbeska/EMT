...
//    public static List<Book> books = new ArrayList<>();
    ...
    public void init(){
        ...
        country = countryService.create(new CountryDto("Macedonia","Europe")).get();
        author = authorService.create(new AuthorDto("Ken","Mak",country.getId())).get();
        bookService.create(new BookDto("EMT", BookCategory.THRILLER, author.getId(),10));
    }
}
